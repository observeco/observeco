...
try:
    ...
    # ponytail: cli_harness.py is missing from main (harness code lives on
    # the WIP merge-capability branch). Lazy-import keeps the CLI usable
    # without it; the harness subcommand appears only when the module exists.
    # Upgrade: land cli_harness.py on main, then remove this fallback.
    harness_app = None
