...
(function () {
  ...
  var SELECTOR = '.hero-flow, .case-bars, .cost-scale, .flywheel-wrap, .rank-bar, .method-pipeline, .data-bar, .odometer, .gauge, .dot-grid, .shield, .ladder, .mountain, .dot-row, .cmp-bars, .donut, .marker-bar, .crowd, .trend-chip, .dot-stream, .white-space-band, .hero-map, .hero-map-col, .outcome-grid';
