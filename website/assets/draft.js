...
(function () {
  ...
  var SELECTOR = '.hero-flow, .process-flow, .case-bars, .phase-bar, .stock-chart, .cost-scale, .flywheel-wrap, .rank-bar, .method-pipeline, .data-bar, .odometer, .gauge, .usa-map, .volvo-mark, .ladder, .mountain, .dot-row, .cmp-bars, .donut, .marker-bar, .crowd, .trend-chip, .dot-stream, .white-space-band, .hero-map, .hero-map-col, .outcome-grid';
