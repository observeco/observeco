...
**Status:** Proposed — pending Sean review and Claude Code independent assessment
...
| | Hermes (Beachhead) | Hermes + OpenClaw | Other frameworks |
|---|---|---|---|
| **Pricing** | Free forever | Pro ($9 Solo) | Partial compatibility |
| **Features** | All features | All features | All features that apply |
| **Gating** | None | None (same features) | None |
| **Ethos** | "We support you first" | "You have our deeper stack" | "We'll do our best" |
| **Banner** | Agent invocation count | Agent invocation count | Agent invocation count |
| **LLM features** | BYOK (`OBSERVECO_LLM_API_KEY`) | BYOK (`OBSERVECO_LLM_API_KEY`) | BYOK (`OBSERVECO_LLM_API_KEY`) |
